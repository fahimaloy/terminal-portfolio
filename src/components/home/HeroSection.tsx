...
import type { PortfolioProfile, PortfolioSkill, PortfolioProject, PortfolioExperience } from '../../utils/api';
...
const HeroSection = forwardRef<HTMLDivElement, HeroSectionProps>(
  (
    { profile, projects, skills, experiences, siteTexts, projectCount, skillCount, expCount, onSend, onOpenChat },
    ref,
  ) => {
